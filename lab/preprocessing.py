...
# ============================================================
# OS and Introduce Date Feature Pipeline
# ============================================================
...
def density_pipeline():
    """
    Pipeline for density feature:
    - Apply log transform
    - Apply StandardScaler
    """
    return make_pipeline(
        FunctionTransformer(apply_log_transform_density),
        SimpleImputer(),
        StandardScaler()
    )
...
preprocessing = ColumnTransformer(
    transformers=[
        ...
        ("thickness", thickness_pipeline(), ["thickness"]),
        ...
        ("inch_ppi_pixel",mean_pipeline(),["size_screen_inch","pixel_per_inch","all_pixels","battery_power_mah",'rate', 'count_raters', 'popularity', 'num_questions', 'num_comments',"suggestions_count",'suggestions_percentage']),
